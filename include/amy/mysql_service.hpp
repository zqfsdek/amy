...
public:
    ...
    explicit mysql_service(asio::io_service& io_service);
    ...
    std::error_code open(implementation_type& impl, std::error_code& ec);
    ...
    std::error_code query(implementation_type& impl,
    ...
    std::error_code autocommit(implementation_type& impl,
                               bool mode,
                               std::error_code& ec);

    std::error_code commit(implementation_type& impl, std::error_code& ec);

    std::error_code rollback(implementation_type& impl, std::error_code& ec);
...
private:
    ...
    std::unique_ptr<asio::io_service> work_io_service_;
